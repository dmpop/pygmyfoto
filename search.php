...
$result = $db->query("SELECT id, title, description, tags, exif FROM photos WHERE tags LIKE '%$tag%' ORDER BY dt DESC");
foreach($result as $row)
{
	print "<tr><td><h2><a class='title' href='photo.php?id=".$row['id']."'>".$row['title']."</h2></a></td></tr>";
	print "<tr><td><p>".$row['description']."</p></td></tr>";
	print "<tr><td valign='top'><p class='box'><img src='images/tag.png' alt='Tags'><em> ".$row['tags']."</em> <a href='photo.php?id=".$row['id']."'><img src='images/photography.png' alt='Permalink'></a> <a href='".$row['osm']."'><img src='images/world.png' alt='OpenStreetMap'></a></p></td></tr>";
